...
export function EditPostForm({
    ...
    const [startDate, setStartDate] = useState(initialDate.includes(",") ? initialDate.split(",")[0].trim() : initialDate);
    const [endDate, setEndDate] = useState(initialDate.includes(",") ? initialDate.split(",")[1].trim() : initialDate);
